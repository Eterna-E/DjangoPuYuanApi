# Generated by Django 3.1.1 on 2020-10-16 08:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pulse', models.DecimalField(decimal_places=0, max_digits=10, null=True)),
                ('recorded_at', models.DateTimeField(blank=True)),
                ('date', models.DateField(auto_now_add=True, null=True)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('uid', models.CharField(blank=True, max_length=100)),
                ('sugar', models.DecimalField(blank=True, decimal_places=0, max_digits=10, null=True)),
                ('timeperiod', models.DecimalField(blank=True, decimal_places=0, max_digits=10, null=True)),
                ('recorded_at', models.DateTimeField(blank=True)),
                ('date', models.DateField(auto_now_add=True, null=True)),
            ],
        ),
